<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CDHomePage.aspx.cs" Inherits="CenterDepot_CDHomePage" %>
   ...
   <script src="../js/amcharts.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function PwdChange() {
            $.ajax({
                type: "POST",
                url: "CDHomePage.aspx/PaperStock",
                data: '{}',
     ...
     <div class="table-responsive">
        <%--<div class="portlet-header ui-widget-header">
         मुख्य पृष्ठ / Home<div style="float:right;">[ All Unit In Metric Ton ]</div>
    </div>--%>
         <div class="portlet-header ui-widget-header">
         मुख्य पृष्ठ / Home<div style="float:right;"></div>
    </div>
            ...
            <div class="" >
					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="caption-subject font-blue-steel bold uppercase"> Paper Mill Challan Details</span>
								</div>							
							</div>
                                       ...
                                       <ItemTemplate>
										...
										<div class="col1">
											<div class="cont">
												...
												<div class="cont-col2">
													<div class="desc">
														<%#Eval("Dta") %> <span class="label label-sm label-warning "> <a href="../CenterDepot/ChallanDetails.aspx?ID=<%# new APIProcedure().Encrypt(Eval("DisTranId").ToString()) %>">	Accept <i class="fa fa-share"></i></a></span>
														</span>
													</div>
												</div>
											</div>
					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="caption-subject font-blue-steel bold uppercase"> Paper Supply Order to Printer</span>
								</div>							
							</div>
                                       ...
                                       <ItemTemplate>
										...
										<div class="col1">
											<div class="cont">
												...
												<div class="cont-col2">
													<div class="desc">
														<%#Eval("Dta") %> <span class="label label-sm label-warning "> <a href="../CenterDepot/RptBalanceReciept.aspx?pid=<%# new APIProcedure().Encrypt(Eval("PrinterID_I").ToString()) %>&acyr=<%# new APIProcedure().Encrypt(Eval("AcadmicYR_V").ToString()) %>">    Take Action <i class="fa fa-share"></i></a></span>
														</span>
													</div>
												</div>
											</div>
            ...
            <div class="" >
					...
					<div class="col-md-6 col-sm-6">
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									<span class="caption-subject font-blue-steel bold uppercase"> Paper Stock</span>
								</div>							
							</div>
