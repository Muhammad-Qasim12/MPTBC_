...
public partial class CenterDepot_CenteralReport_GSMWisePrinterReport : System.Web.UI.Page
{
    DataSet ds;
    DataTable Dt, dt;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            dsr = obCommonFuction.FillDatasetByProc("call USP_PPR0022_StockReportByAcYear('" + ddlPrinterName.SelectedItem.Value + "','" + txtFromDate.Text.ToString().Replace("-", "/") + "','" + txtToDate.Text.ToString().Replace("-", "/") + "','"+ddlAcYear.SelectedItem.Text+"',1)");
            if (dsr.Tables != null)
                Dt = dsr.Tables[0];
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/CenterDepot/CenteralReport/rptPrinterwiseGSM.rdlc");
