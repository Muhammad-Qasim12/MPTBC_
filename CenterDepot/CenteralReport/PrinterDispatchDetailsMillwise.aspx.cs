...
public partial class CenterDepot_CenteralReport_PrinterDispatchDetails : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if (ddlPrinter.SelectedIndex > 0)
        {
            ...
            Dt = obCommonFuction.FillTableByProc("call GetDetailPrinter_millWise('" + DdlACYear.SelectedValue + "'," + ddlPrinter.SelectedValue + "," + ddlGSM.SelectedValue   + ")");
            ...
            if (Dt.Rows.Count > 0)
            {
               ...
               // ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/CenterDepot/CenteralReport/report.rdlc");
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/CenterDepot/CenteralReport/Report_newmillwise.rdlc");
