...
public partial class CenterDepot_PaperDetilasNew_UrgentWork : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ds = obCommonFuction.FillDatasetByProc("CALL USP_PPR0020_GetProcReelStockEntryNew_Part2(" + ddlVenderFill.SelectedValue + ",'" + ddlGSM.SelectedValue + "','" + txtRoleNo.Text + "',9,'" + ddlAcYear.SelectedItem.Text + "')");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (txtRoleNo.Text.ToString().Trim().ToUpper() == lblRollNo.Text.ToString().Trim())
        {
            ...
            comm.FillDatasetByProc(@"insert into tbl_paperallotment_Part2(PaperType_I, PaperMstrTrId_I, CoverInformation, RollNo, NetWt, GrossWt, PaperVendorTrId_I, PaperVendorName_V, TotalSheets, OrderNo, Fyear,ActTotalSheets,DefectedReelSts,NetWetMt,GrossWtMT,PrinterID_I, OldNetWt, OldGrossWt, OldNetWtMt,OldGrossWtMT,RollStockID_I,UserID_A)values ('" + lblPaperType_I.Text + "','" + lblPaperMstrTrId_I.Text + "','" + lblCoverInformation.Text + "','" + lblRollNo.Text + "','" + txtNetWt.Text + "','" + txtGrossWt + "','" + lblPaperVendorTrId_I.Text + "','" + ddlVenderFill.SelectedItem.Text + "','" + lblTotalSheets.Text + "','" + TextBox1.Text + "','" + ddlAcYear.SelectedValue + "','" + lblActTotalSheets.Text + "','" + lblReelType.Text + "'," + lblNetWt1.ToString() + "," + lblGrossWt1.ToString() + "," + PrinterID_I + "," + lblNetWt.Text + "," + lblGrossWt.Text + "," + lblNetWt_old.ToString() + "," + lblGrossWt_old.ToString() + ",'" + hdnRollStockID_I.Value + "'," + Session["UserID"].ToString() + ")");
    ...
    {
        CommonFuction comm = new CommonFuction();
        GridView1.DataSource = comm.FillDatasetByProc("select * from tbl_paperallotment_Part2 where OrderNo='" + TextBox1.Text + "' and Fyear='" + ddlAcYear.SelectedValue + "' order by ID");
        GridView1.DataBind();
    }
    public void fillGrd()
    {
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        comm.FillDatasetByProc("delete from tbl_paperallotment_Part2 where ID=" + GridView1.DataKeys[e.RowIndex].Value + " ");
        if (RadioButtonList1.SelectedValue == "1")
        { fillGrd12(); }
        else
        { fillGrd(); }
