<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BlockWiseDistributionaNew.aspx.cs" Inherits="Distribution_BlockWiseDistributionaNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="box">
        <div class="card-header">
            <h2><span>
               पाठ्यपुस्तको की ब्लॉकवार मांग एवं प्रदाय की रिपोर्ट
                </span></h2>
        </div>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="width: 30%; font-size: medium;" valign="top">
                            ...
                            <asp:DropDownList ID="DDLClass" runat="server"  CssClass="txtbox" onselectedindexchanged="DDLClass_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <asp:DropDownList ID="DdlDistrict" runat="server" CssClass="txtbox"  Enabled ="false">
                            ...
                            <asp:Label ID="LblScheme" runat="server">&#2351;&#2379;&#2332;&#2344;&#2366; / Scheme: </asp:Label>
