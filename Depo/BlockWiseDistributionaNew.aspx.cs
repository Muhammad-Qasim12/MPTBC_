...
public partial class Distribution_BlockWiseDistributionaNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ddlMedium.DataSource = obCommonFuction.FillDatasetByProc("CALL USP_ADM015_SchemeLoadClassWise('" + DDLClass.SelectedValue.ToString() + "')");
            ddlMedium.DataTextField = "SchemeName_Hindi";
            ddlMedium.DataValueField = "SchemeID";
            ddlMedium.DataBind();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        rds.Name = "DataSet1";
        DS = obCommonFuction.FillDatasetByProc(@"CALL USP_GetBookDistributionINBlockDepoNew('" + DdlACYear.SelectedItem.Text + "'," + ddlMedium.SelectedValue + ",'" + Classes + "'," + DDlDepot.SelectedValue + "," + DDlDemandType.SelectedValue + ")");
