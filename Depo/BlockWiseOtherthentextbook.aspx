<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BlockWiseOtherthentextbook.aspx.cs" Inherits="Depo_BlockWiseOtherthentextbook" %>
    ...
    <div class="box table-responsive">
        ...
        <div style="padding-right: 10px; padding-left: 10px; padding-bottom: 0px; padding-top: 0px">
            <table width="100%">
                ...
                <tr>
                    <td>
                        <reportviewer id="RVDistrictSupply" runat="server" width="100%">
                    </reportviewer>
                    </td>
                </tr>
            </table>
