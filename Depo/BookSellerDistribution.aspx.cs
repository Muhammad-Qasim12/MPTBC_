...
public partial class Depo_BookSellerDistribution : System.Web.UI.Page
{
    ...
    public void fillgrd()
    {
       ...
       // DataSet view = comm.FillDatasetByProc("Call USP_DPT012_BookDemandData_LoadNew(" + ddlBookSllerName.SelectedValue + "," + DropDownList1.SelectedValue + ")");
        DataSet view = comm.FillDatasetByProc("call USP_DPTGetbookSellerDetails (" + ddlBookSllerName.SelectedValue + "," + DropDownList1.SelectedValue + ","+Session["UserID"]+")");
