...
public partial class Depo_DepoAwavtanPrapti : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           // DataSet dd = obCommonFuction.FillDatasetByProc("call USP_GM_DepowiseavantanpraptiDepo_All ('" + DdlACYear.SelectedValue + "','" + Convert.ToString(Session["ram"]) + "') ");
            Dt = dd.Tables[0];
            rds.Value = Dt;
            //  ReportViewer1.LocalReport.ReportPath = Server.MapPath("Report3.rdlc");
          ReportViewer1.LocalReport.ReportPath = Server.MapPath("Report5.rdlc");
