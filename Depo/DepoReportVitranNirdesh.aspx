<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DepoReportVitranNirdesh.aspx.cs" Inherits="Depo_DepoReportVitranNirdesh" %>
                                                ...
                                                <td colspan="4" style="font-size: 13px; font-weight: 200; text-align: center;">
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="tab">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="&#2310;&#2352;&#2381;&#2337;&#2352; &#2344;&#2306;&#2348;&#2352; ">
                                                                <ItemTemplate>
                                                                   <%-- <a href="ViewMoreDetails.aspx?id=<%# api.Encrypt(Eval("OrderNo").ToString ()) %>"><%#Eval("Acyear")%></a>--%>
                                                                     <a href="ViewMoreDetails.aspx?ID=<%#Eval("OrderNo") %>&Year=<%# Eval("Acyear") %>" target="_blank"><%#Eval("OrderNo")%></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
