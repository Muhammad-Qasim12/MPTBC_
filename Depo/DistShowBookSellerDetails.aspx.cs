...
public partial class Depo_DistShowBookSellerDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            obDPT_DepotMaster.DepoTrno_I = Convert.ToInt32(Request.QueryString["DepoID"]);
    ...
    {
        Response.Redirect("DistributionabookSellerReport.aspx");
    }
}