<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Formate11Report.aspx.cs" Inherits="Depo_Formate11Report" %>
            ...
            <div class="table-responsive">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:Button ID="Button1" runat="server" CssClass="btn" OnClick="Button1_Click1" Text="Show Data" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
