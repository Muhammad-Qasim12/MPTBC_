...
public partial class Depo_GMAvantanPrapti : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                DataSet dd = obCommonFuction.FillDatasetByProc("call USP_GM_Depowiseavantanprapti ('" + DdlACYear.SelectedValue + "') ");
                Dt = dd.Tables[0];
                rds.Value = Dt;
