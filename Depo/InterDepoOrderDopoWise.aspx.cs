...
public partial class Depo_InterDepoOrderDopoWise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
       {
            ...
            //ddlReqDepo.Enabled = false;
        //    ddlReqDepo.SelectedValue = Convert.ToString(Session["UserID"]);
          //  ddlReqDepo_SelectedIndexChanged( sender,  e);
            GridFillLoad();
            // GridFillLoad();
        }
    }
    ...
    public void GridFillLoad()
    {
        try
        {
            if (ddlReqDepo.SelectedItem.Text != "Select")
            {
                ...
                DataSet dd = obj.FillDatasetByProc("call USP_DPO002_InterDepoTransferShowData(0,0,0," + Session["UserID"] + ",4)");
    ...
    {
        DataSet dd = obj.FillDatasetByProc("call USP_DPO002_InterDepoTransferShowDataDepo(0," + ddlReqDepo.SelectedValue + ",0," + Session["userID"] + ",7)");
      GrdDepoQtyMaster.DataSource = dd.Tables[0];
      GrdDepoQtyMaster.DataBind();
    ...
    protected void showReport_Click(object sender, EventArgs e)
    {
        ...
        //    GrdDepoQtyMaster.DataSource = null;
        //    GrdDepoQtyMaster.DataBind();
        //    GridView1.DataSource = obj.FillDatasetByProc("call USP_GetInterDepoReportNew('" + DdlACYear.SelectedValue + "','" + Convert.ToDateTime(TextBox1.Text, cult).ToString("yyyy-MM-dd") + "','" + Convert.ToDateTime(txtTodate.Text, cult).ToString("yyyy-MM-dd") + "')");
        //    GridView1.DataBind();
        //}
        //catch { }
    }
