<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InterDepoReceivedStatus.aspx.cs" Inherits="Depo_InterDepoReceivedStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="box">
                    <div class="card-header">
                     <h2> अंतरडिपो प्राप्ति &#2325;&#2368; &#2360;&#2381;&#2341;&#2367;&#2340;&#2367; </h2>
        ...
        <table width="100%">
            ...
            <tr><td>&#2346;&#2381;&#2352;&#2366;&#2346;&#2381;&#2340;&#2325; &#2337;&#2367;&#2346;&#2379; </td><td>
                ...
                &nbsp;<asp:Button ID="btnExportPDF0" runat="server" CssClass="btn"  Text="Export to Execle" Visible="False" Width="201px" OnClick="btnExportPDF_Click" />
                   
                </td></tr>
            <tr><td colspan="4">
                <div id="ExportDiv" runat="server">
                 <center>  <b>अंतरडिपो प्राप्ति की स्थिति</b></center> 
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="tab">
                    <Columns>
                        ...
                        <asp:BoundField DataField="DepoName_V" HeaderText="प्रदायक डिपो " />
                    </Columns>
                </asp:GridView></div>
                </td></tr>
        </table>
