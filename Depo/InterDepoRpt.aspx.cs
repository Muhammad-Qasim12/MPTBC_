...
public partial class Depo_InterDepoRpt : System.Web.UI.Page
{
    ...
    protected void Button12_Click(object sender, EventArgs e)
    {
        ...
        GridView1.DataSource = obCommonFuction.FillDatasetByProc(@"Call USP_interDepoRep('" + TitleID + "','" + SubTitle + "','" + ddlFyYr.SelectedItem.Text + "',0) ");
        GridView1.DataBind();
