...
public partial class Depo_LoojBundleDetails : System.Web.UI.Page
{
    ...
    {
        DataSet ds = comm.FillDatasetByProc(@"select TitleID_I,  TitleHindi_V from acd_titledetail where Medium_I=" + ddlMedium.SelectedValue + " and  ClassTrno_I=" + ddlCls.SelectedValue + "");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                comm.FillDatasetByProc("call  USP_DPT_LoojBandalSaveSamany(" + ddlsubject.SelectedValue + "," + ddlCls.SelectedValue + "," + ddlMedium.SelectedValue + "," + TextBox1.Text + "," + ((TextBox)GridView1.Rows[i].FindControl("TextBox2")).Text + "," + Session["UserID"] + ",0,'" + ddlfyyear.SelectedValue + "')");
            }
            GridView1.DataSource = null;
            GridView1.DataBind();
            DataSet dd = comm.FillDatasetByProc("call  USP_DPT_LoojBandalSaveSamany(" + ddlsubject.SelectedValue + "," + ddlCls.SelectedValue + "," + ddlMedium.SelectedValue + "," + TextBox1.Text + ",0," + Session["UserID"] + ",1,'" + ddlfyyear.SelectedValue + "')");
    ...
    protected void ddlsubject_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataSet dd = comm.FillDatasetByProc("call  USP_DPT_LoojBandalSaveSamany(" + ddlsubject.SelectedValue + "," + ddlCls.SelectedValue + "," + ddlMedium.SelectedValue + ",0 ,0," + Session["UserID"] + ",1,'" + ddlfyyear.SelectedValue + "')");
        GridView2.DataSource = dd.Tables[0];
        GridView2.DataBind();
    ...
    protected void TextBox2_TextChanged(object sender, EventArgs e)
    {
        ...
        DataSet dd1 = comm.FillDatasetByProc(" call USP_DPTCheckBandalS(" + ddlsubject.SelectedValue + "," + txt1.Text + ")");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            DataSet dt = comm.FillDatasetByProc(@"call dptStockDetailsReport(" + Session["USerID"] + "," + ddlsubject.SelectedValue + ",0,0,'"+ddlfyyear.SelectedItem.Text+"')");
