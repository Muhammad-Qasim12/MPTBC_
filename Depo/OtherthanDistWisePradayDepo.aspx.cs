...
public partial class Depo_OtherthanDistWisePradayDepo : System.Web.UI.Page
{
    DataSet ds;
    DataTable Dt, dt;
    ...
    private void FillReport()
    {
        ...
        Dt = comm.FillDatasetByProc("call USP_OtherThanDistributeDepo('" + ddlLetterNo.SelectedValue + "','"+Session["UserID"]+"')").Tables[0];
