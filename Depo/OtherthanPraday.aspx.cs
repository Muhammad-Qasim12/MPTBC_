...
public partial class Depo_OtherThankPraday : System.Web.UI.Page
{
    ...
    {
        if (DropDownList1.SelectedValue == "1" || DropDownList1.SelectedValue == "2" || DropDownList1.SelectedValue == "6")
        {
        ...
        {
            if (DropDownList1.SelectedValue == "4" || DropDownList1.SelectedValue == "3")
            {
                grBook.DataSource = obCommonFuction.FillDatasetByProc("call USP_OtherThanTextbook_dist(" + Session["UserID"] + "," + DdlDistrict.SelectedValue + "," + ddlBlock.SelectedValue + "," + ddlSessionYear.SelectedValue + ",'" + ddlSessionYear.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "')");
                grBook.DataBind();
            }
            else
            {
