...
public partial class Depo_OtherthanPradayDist : System.Web.UI.Page
{
    ...
    {
        if (DropDownList1.SelectedValue == "1" || DropDownList1.SelectedValue == "2" || DropDownList1.SelectedValue == "4")
        {
            grBook.DataSource = obCommonFuction.FillDatasetByProc("call USP_OtherThanTextbookDist(" + Session["UserID"] + "," + ddlBlock.SelectedValue + "," + ddlSessionYear.SelectedValue + ",'" + ddlSessionYear.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "')");
            grBook.DataBind();
        }
        else
        {
            ...
            {
                grBook.DataSource = obCommonFuction.FillDatasetByProc("call USP_OtherThanTextbookDist(" + Session["UserID"] + "," + DdlDistrict.SelectedValue + "," + ddlSessionYear.SelectedValue + ",'" + ddlSessionYear.SelectedItem.Text + "','1')");
                grBook.DataBind();
            }
            else
            {
                grBook.DataSource = obCommonFuction.FillDatasetByProc("call USP_OtherThanTextbookDist(" + Session["UserID"] + "," + DdlDistrict.SelectedValue + "," + ddlSessionYear.SelectedValue + ",'" + ddlSessionYear.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "')");
                grBook.DataBind();
            }
