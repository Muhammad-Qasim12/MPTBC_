...
public partial class Depo_OtherthanTextbookBlockPraday : System.Web.UI.Page
{
    DataSet ds;
    DataTable Dt, dt;
    ...
    private void FillReport()
    {
        ...
        Dt = comm.FillDatasetByProc("call USP_OtherhanBlockWise('" + ddlLetterNo.SelectedValue + "')").Tables[0];
