<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OtherthanTextbookBlockPradayDepo.aspx.cs" Inherits="Depo_OtherthanTextbookBlockPradayDepo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box table-responsive">
        <div class="card-header">
            <h2 class="auto-style1">ब्लाकवार अन्य  पाठ्यसामग्री का प्रदाय</h2>
        </div>
