...
public partial class Depo_Rpt_DIB006_DepowiseSupplyDepo : System.Web.UI.Page
{
    DataSet ds;
    DataTable Dt, dt;
    ...
    private void FillReport()
    {
       ...
       // Dt = comm.FillDatasetByProc("call USP_DIB_Rpt001_DepowiseDemandNew('" + ddlLetterNo.SelectedValue + "','0'," + Session["UserID"] + ",'4')").Tables[0];
        Dt = comm.FillDatasetByProc("call USP_DIB_Rpt001_DepowiseDemand('" + ddlLetterNo.SelectedValue + "','0')").Tables[0];
