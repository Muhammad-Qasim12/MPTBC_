...
using System.IO;
public partial class Depo_SecurtyDeposityReturn : System.Web.UI.Page
{
    ...
    public void FillDataPrinter()
    {
        try
        {
            ...
            DataSet dd = comm.FillDatasetByProc("call USP_SecurityPrinter(0,'" + DdlACYear.SelectedItem.Text + "')");
    ...
    protected void GrdPrinterId_SelectedIndexChanged(object sender, EventArgs e)
    {
        HiddenField1.Value = GrdPrinterId.SelectedDataKey.Value.ToString();
        lblOwnerName.Text = GrdPrinterId.SelectedRow.Cells[1].Text;
        lblPartyName.Text = GrdPrinterId.SelectedRow.Cells[1].Text;
        lblSecurityAmount.Text = GrdPrinterId.SelectedRow.Cells[3].Text;
        lblContractNo.Text = GrdPrinterId.SelectedRow.Cells[7].Text;
        lblagrement.Text = GrdPrinterId.SelectedRow.Cells[6].Text;

        aa.Style.Add("display", "Block");
    }
    protected void GrdPrinterId_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        
        GrdPrinterId.PageIndex = e.NewPageIndex;
        FillDataPrinter();
