...
public partial class Depo_StockPosition : System.Web.UI.Page
{
  ...
  CultureInfo cult = new CultureInfo("gu-IN", true);
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            ds = obCommonFuction.FillDatasetByProc("call USP_MPTBC_GET_STOCK_POSITION(" + Session["UserID"] + "," + ddlTital.SelectedValue + "," + ddlMedium.SelectedValue + ",'" + Convert.ToDateTime(TextBox1.Text, cult).ToString("yyyy-MM-dd") + "','" + Convert.ToDateTime(TextBox2.Text, cult).ToString("yyyy-MM-dd") + "')");
    ...
    public void LoadReport(DataSet dsGSR, string DepoName, string Title, string FinancialYear)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Depo/RPTStockPossition.rdlc");
