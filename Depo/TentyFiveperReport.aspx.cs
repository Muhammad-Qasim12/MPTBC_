...
public partial class Depo_TentyFiveperReport : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            DataSet ds = obCommanFun.FillDatasetByProc("call USP_DPTTwentyFiveReport('" + Convert.ToDateTime(txtFromdate.Text, cult).ToString("yyyy-MM-dd") + "','" + Convert.ToDateTime(txtTodate.Text, cult).ToString("yyyy-MM-dd") + "', '" + Convert.ToInt32(Session["UserID"]) + "'," + PrinID + ",'"+DdlACYear.SelectedItem.Text+"')");
