<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateBookSellerChallan.aspx.cs" Inherits="Depo_UpdateBookSellerChallan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="box">
        ...
        <div style="padding-right: 10px; padding-left: 10px; padding-bottom: 0px; padding-top: 0px">
            <table width="100%">
                ...
                <tr>
                    <td style="text-align: left">&#2346;&#2369;&#2360;&#2381;&#2340;&#2325; &#2357;&#2367;&#2325;&#2381;&#2352;&#2375;&#2340;&#2366; / Book Seller 
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlBookSllerName" runat="server"
                            AutoPostBack="True"
                            OnSelectedIndexChanged="ddlBookSllerName_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                ...
                <tr id="a11" runat="server">
                    <td style="text-align: left">&#2325;&#2369;&#2354; &#2352;&#2366;&#2358;&#2368; / Net Amount</td>
                    <td>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="&#2360;&#2375;&#2357;  &#2325;&#2352;&#2375;&#2306; " CssClass="btn" OnClick="Button1_Click" Visible="false" />
                        &nbsp;
                         <asp:Button ID="Button2" runat="server" Text="Delete" CssClass="btn" Visible="False" OnClick="Button2_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div id="Messages" style="display: none;" class="popupnew1" runat="server">
            ...
            <table width="100%">
                ...
                <tr runat="server">
                    <td colspan="2">
                        <asp:Button ID="Button3" runat="server" Text="&#2360;&#2375;&#2357; &#2325;&#2352;&#2375; " CssClass="btn" />
                        <asp:Button ID="Button4" runat="server" Text="&#2348;&#2344;&#2381;&#2342; &#2325;&#2352;&#2375;&#2306; " CssClass="btn" OnClick="Button4_Click" /></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div id="Div2" style="display: none;" class="popupnew1" runat="server">
        <table>
            <tr>
                <td>&#2325;&#2376;&#2358; &#2350;&#2375;&#2350;&#2379; &#2325;&#2381;&#2352;&#2350;&#2366;&#2306;&#2325; / Cash Memo No :       <asp:TextBox ID="txtChalanNo" runat="server" MaxLength="10"></asp:TextBox>
                </td>
                <td>&#2325;&#2376;&#2358; &#2350;&#2375;&#2350;&#2379; &#2342;&#2367;&#2344;&#2366;&#2306;&#2325;/ Cash Memo Date </td>
                <td>
                    <asp:TextBox ID="txtChalanDate" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>&#2348;&#2367;&#2354;&#2381;&#2335;&#2368; &#2325;&#2381;&#2352;&#2350;&#2366;&#2306;&#2325; / Bilti No  :</td>
                <td>
                    <asp:TextBox ID="txtGRNO" MaxLength="15" runat="server"></asp:TextBox>
                </td>
                <td>&#2348;&#2367;&#2354;&#2381;&#2335;&#2368; &#2342;&#2367;&#2344;&#2366;&#2306;&#2325;/ Bilti Date </td>
                <td>
                    <asp:TextBox ID="txtGRNDate" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>&#2346;&#2381;&#2352;&#2366;&#2346;&#2381;&#2340;&#2325;&#2352;&#2381;&#2340;&#2366; &#2325;&#2366; &#2344;&#2366;&#2350; /Receiver Name :</td>
                <td>
                    <asp:TextBox ID="txtReceiverName" onkeypress='javascript:tbx_fnAlphaOnly(event, this);' MaxLength="50" runat="server"></asp:TextBox>
                </td>
                <td>&#2337;&#2381;&#2352;&#2366;&#2311;&#2357;&#2352; &#2325;&#2366; &#2350;&#2379;&#2348;&#2366;&#2312;&#2354; &#2344;&#2306;&#2348;&#2352; /Driver Mobile No </td>
                <td>
                    <asp:TextBox ID="txtDriverMobileNo" onkeypress='javascript:tbx_fnInteger(event, this);' MaxLength="10" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>&#2335;&#2381;&#2352;&#2325; &#2344;&#2306;&#2348;&#2352; /Truck No :</td>
                <td>
                    <asp:TextBox ID="txtTrucko" MaxLength="10" runat="server"></asp:TextBox>
                </td>
                <td>&#2335;&#2367;&#2346;&#2381;&#2346;&#2339;&#2368;/Remark :</td>
                <td>
                    <asp:TextBox ID="txtRemark" TextMode="MultiLine" runat="server" onkeypress='javascript:tbx_fnAlphaOnly(event, this);' MaxLength="200"></asp:TextBox></td>
            </tr>

            <tr>
                <td>
                    <asp:Button Text="Save" runat="server" OnClick="btnSave" ID="btnSaveMasterData" CssClass="btn" />
                    &nbsp;<asp:Button ID="Button6" runat="server" Text="&#2348;&#2344;&#2381;&#2342; &#2325;&#2352;&#2375;&#2306; " CssClass="btn" OnClick="Button5_Click" />
                </td>
            </tr>
    ...
    <div id="Div4" style="display: none;" class="popupnew1" runat="server">
        <table width="100%">
            ...
            <tr>
                <td>&#2344;&#2357;&#2368;&#2344; &#2346;&#2369;&#2360;&#2381;&#2340;&#2325; &#2360;&#2306;&#2326;&#2381;&#2351;&#2366;  </td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:Button ID="Button5" runat="server" CssClass="btn" Text="&#2360;&#2369;&#2352;&#2325;&#2381;&#2359;&#2367;&#2340; &#2325;&#2352;&#2375;&#2306; " OnClick="btnSave1" /></td>
                <td>
                    <asp:Button ID="Button8" runat="server" CssClass="btn" Text="&#2348;&#2306;&#2342; &#2325;&#2352;&#2375;&#2306;  " OnClick="btnClose" /></td>
            </tr>
        </table>
    </div>
    ...
    <div id="Div6" style="display: none;" class="popupnew1" runat="server">
        <table width="100%">
            <tr>
                <td>&#2350;&#2366;&#2343;&#2381;&#2351;&#2350; &#2325;&#2366; &#2344;&#2366;&#2350;  </td>
                <td>
                    <asp:DropDownList ID="ddlMedium" runat="server" CssClass="txtbox"></asp:DropDownList></td>
                <td></td>
                <td>
                    <asp:DropDownList ID="ddlClass" runat="server" CssClass="txtbox" OnSelectedIndexChanged="ddlMediumChange" AutoPostBack="true"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>&#2346;&#2369;&#2360;&#2381;&#2340;&#2325; &#2325;&#2366; &#2344;&#2366;&#2350; :
                ...
                <td>
                    <asp:Button ID="Button9" runat="server" CssClass="btn" Text="&#2360;&#2369;&#2352;&#2325;&#2381;&#2359;&#2367;&#2340; &#2325;&#2352;&#2375;&#2306; " OnClick="btnSave2" /><asp:Button ID="Button10" runat="server" CssClass="btn" Text="&#2348;&#2306;&#2342; &#2325;&#2352;&#2375;&#2306;  " OnClick="btnClose1" /></td>
            </tr>
        </table>
    </div>
</asp:Content>
