<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewBookReceived.aspx.cs" 
    Inherits="Depo_ViewBookReceived" %>
        ...
        <table border="1" class="auto-style1" width="100%">
            ...
            <tr align="right">
                <td align="right" colspan="4">
                    ...
                    <br />  <asp:Label ID="Label4" runat="server" Text=""></asp:Label></b></td>
            </tr>
        </table>
    </div>
            </div> </div> 
