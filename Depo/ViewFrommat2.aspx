<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewFrommat2.aspx.cs" Inherits="Depo_ViewFrommat2" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="tab">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="&#2325;&#2325;&#2381;&#2359;&#2366;">
                                                 <ItemTemplate>
                                                <a href="Formate2.aspx?Year=<%#Eval("Acyear")%>&MediumIDa=<%#Eval("MediumID") %>&Classtra=<%# Eval ("ClassID") %>" > <%#Eval("ClassID")%></a>
                                                     </ItemTemplate>
