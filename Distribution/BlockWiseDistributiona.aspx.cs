...
public partial class Distribution_BlockWiseDistributiona : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DDlDepot.DataSource = obCommonFuction.FillDatasetByProc("CALL USP_ADM009_DistrictMasterLoad(0)");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        rds.Name = "DataSet1";
        DS = obCommonFuction.FillDatasetByProc(@"CALL USP_GetBookDistributionINBlock('" + DdlACYear.SelectedItem.Text + "'," + ddlMedium.SelectedValue + ",'" + Classes + "'," + DDlDepot.SelectedValue + ","+DDlDemandType.SelectedValue+")");
