...
using System.IO;
public partial class Distribution_DemandRound : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        DataSet dd = comm.FillDatasetByProc("call GetDemandFinal('" + DdlACYear.SelectedItem.Text + "'," + DepoTrno_Ia + "," + MediumIDa + ",'" + classA + "','" + Bookstatus + "')");
