...
public partial class Distribution_DemandWithVitrnNirdesh : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitleName.Text = "डिपोवार मांग एवं वितरण निदेश र्की रिपोर्ट ";
        ...
        if (!Page.IsPostBack)
        {
            ...
            DropDownList1.DataSource = obCommonFuction.FillDatasetByProc("CALL USP_DD_SelectMainBookDepot1()");
    ...
    public void LoadReport()
    {
        ...
        Dt = obCommonFuction.FillTableByProc(@"CALL USP_DisRpt_DepotWiseDemandVitranNirdesh('" + Classes + "'"
                                                                                 + "," + Convert.ToInt32(DdlScheme.SelectedValue)
                                                                                 + ",'" + Convert.ToString(DdlACYear.SelectedValue)
                                                                                 + "'," + DDlDemandType.SelectedItem.Value + ","+DropDownList1.SelectedValue+")");

        // rds.Value = DS.Tables[0];
        string Title = "";
        Title = " कक्षा : " + DDLClass.SelectedItem.Text.ToString().Replace("-All-", "सभी") + " माध्यम : " + DdlScheme.SelectedItem.Text.ToString().Replace("-All-", "सभी") + " मांग का प्रकार: " + DDlDemandType.SelectedItem.Text+" एवं वितरण निर्देश";


        ReportDataSource rds = new ReportDataSource("DataSet1", Dt);
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Distribution/DemandVitran.rdlc");
        ...
        Param[2] = new ReportParameter("DepoName", DropDownList1.SelectedItem.Text);
