...
public partial class Distribution_DistrictWiseDistribution : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        rds.Name = "DataSet1";
        DS = obCommonFuction.FillDatasetByProc(@"CALL USP_GetBookDistributionINDist('" + DdlACYear.SelectedItem.Text + "'," + ddlMedium.SelectedValue + ",'" + Classes + "'," + DDlDepot.SelectedValue + "," + DDlDemandType.SelectedValue + ")");

        rds.Value = DS.Tables[0];
        Title = " कक्षा : " + Classes + " माध्यम  : " + ddlMedium.SelectedItem.Text.ToString().Replace("-All-", "सभी")+ "  डिपो का नाम "+DDlDepot.SelectedItem.Text;
