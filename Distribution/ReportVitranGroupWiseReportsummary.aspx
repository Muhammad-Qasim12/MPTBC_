<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportVitranGroupWiseReportsummary.aspx.cs" Inherits="Distribution_ReportVitranGroupWiseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="box">
        <div class="card-header">
            <h2>
                <span>
                    <asp:Label ID="lblTitleName" runat="server"> पाठ्यपुस्तको की ग्रुपवार वितरण की रिपोर्ट</asp:Label>
                </span></h2>
        </div>
