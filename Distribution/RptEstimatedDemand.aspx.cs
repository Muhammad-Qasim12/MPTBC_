...
public partial class Distrubution_RptEstimatedDemand : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet obDataset = obCommonFuction.FillDatasetByProc("Call USP_DIS_RptDemandEstimation('" + DdlACYear.SelectedValue.ToString() + "'," + Convert.ToInt32(DdlDepot.SelectedValue) + "," + Convert.ToInt32(DdlMedium.SelectedValue) + ",'" + strclasses + "','"+DropDownList2.SelectedValue+"')");
            if (obDataset.Tables[0].Rows.Count > 0)
            {
                lblAcademicYear.Text = "शिक्षा सत्र : " + DdlACYear.SelectedItem.Text;
                lblDate.Text = System.DateTime.Now.ToString("d MMM yyyy");
                lblTitle.Text = " डिपो का नाम : " + DdlDepot.SelectedItem.Text + ", " + "माध्यम : " + DdlMedium.SelectedItem.Text + " ," + " कक्षा : " + strclasses + "";
