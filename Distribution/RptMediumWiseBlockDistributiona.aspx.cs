...
public partial class Distribution_RptMediumWiseBlockDistributiona : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        rds.Name = "DataSet1";
        DS = obCommonFuction.FillDatasetByProc(@"CALL USP_GetBookDistributionINBlock('"+DdlACYear.SelectedItem.Text+"',"+ddlMedium.SelectedValue+",'"+Classes+"',0,0)");

        rds.Value = DS.Tables[0];
        Title = " कक्षा : " + Classes + " माध्यम  : " + ddlMedium.SelectedItem.Text.ToString().Replace("-All-", "सभी") ;
