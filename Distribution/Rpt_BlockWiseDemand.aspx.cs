...
public partial class Distrubution_Rpt_BlockWiseDemand : System.Web.UI.Page
{
    DataTable Dt;
    ...
    public void LoadReport()
    {
        ...
        DS = obCommonFuction.FillDatasetByProc(@"CALL USP_DisRpt_BlockWiseDemand(" + Convert.ToInt32(DdlDistrict.SelectedValue)
        ...
        Title = "डिपो : " + DDlDepot.SelectedItem.Text + ", " + " जिला : " + DdlDistrict.SelectedItem.Text + ", " + " कक्षा : " + DDLClass.SelectedItem.Text + ", " + " योजना : " + DdlScheme.SelectedItem.Text.ToString().Replace("-All-", "सभी") + " मांग का प्रकार: " + DDlDemandType.SelectedItem.Text;
