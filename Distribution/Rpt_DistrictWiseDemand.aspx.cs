...
public partial class Distrubution_Rpt_DistrictWiseDemand : System.Web.UI.Page
{
    DataTable Dt;
    ...
    public void LoadReport()
    {
        ...
        Dt = obCommonFuction.FillTableByProc(@"CALL USP_DisRpt_DistrictWiseDemand(" + 0
       ...
       // rds.Value = DS.Tables[0];
        ...
        string Title = "";
        Title = "डिपो : " + DDlDepot.SelectedItem.Text + ", " + " कक्षा : " + DDLClass.SelectedItem.Text.ToString().Replace("-All-", "सभी") + " योजना : " + DdlScheme.SelectedItem.Text.ToString().Replace("-All-", "सभी") + " मांग का प्रकार: " + DDlDemandType.SelectedItem.Text;
