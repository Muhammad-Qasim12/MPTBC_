...
public partial class Distrubution_Rpt_SchemeWiseDepoWiseDemand : System.Web.UI.Page
{
    DataTable Dt;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitleName.Text = "डिपोवार मांग की रिपोर्ट (योजना) / Demand Of Depot Wise Report (Scheme)";
    ...
    public void LoadReport()
    {
        ...
        DS = obCommonFuction.FillDatasetByProc(@"CALL USP_DisRpt_DepoWiseDemandScheme(0,0,'',0,'" + Convert.ToString(DdlACYear.SelectedValue)
                                                                                 + "'," + DDlDemandType.SelectedItem.Value + ")");

        rds.Value = DS.Tables[0];
        string Title = "";
        Title = " मांग का प्रकार: " + DDlDemandType.SelectedItem.Text;
        ...
        //else
        //{
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Distribution/Report_SchemeDepoWiseDmnd.rdlc");
        // }
