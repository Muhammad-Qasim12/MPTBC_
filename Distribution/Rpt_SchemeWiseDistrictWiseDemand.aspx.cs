...
public partial class Distrubution_Rpt_SchemeWiseDistrictWiseDemand : System.Web.UI.Page
{
    DataTable Dt;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitleName.Text = " जिलावार मांग की रिपोर्ट (योजना) / Demand Of District Wise Report (Scheme)";
    ...
    public void LoadReport()
    {
        ...
        DS = obCommonFuction.FillDatasetByProc(@"CALL USP_DisRpt_DistrictWiseDemandScheme(" + Convert.ToInt32(DDlDepot.SelectedValue) + "," + Convert.ToInt32(DDlDepot.SelectedValue) + ",'',0,'" + Convert.ToString(DdlACYear.SelectedValue)
                                                                                 + "'," + DDlDemandType.SelectedItem.Value + ")");

        rds.Value = DS.Tables[0];
        string Title = "";
        Title = "डिपो : " + DDlDepot.SelectedItem.Text + ", " + " मांग का प्रकार: " + DDlDemandType.SelectedItem.Text;
        ...
        //else
        //{
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Distribution/Report_SchemeDistrictWiseDmnd.rdlc");
        // }
