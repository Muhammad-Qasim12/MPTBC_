<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockBarCode.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="Distrubution_StockBarCode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<style> @font-face { font-family: Free3of9Regular; src: url(../BarCodeFont/FREE3OF9.eot?) format(eot),url(../BarCodeFont/FREE3OF9.woff) format(woff), url(../BarCodeFont/FREE3OF9.ttf) format(truetype), url(../BarCodeFont/FREE3OF9.svg#Free3of9) format(svg);font-weight: normal;font-style: normal;}');
