<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WithdraVitrannirdesh.aspx.cs" Inherits="Distribution_WithdraVitrannirdesh" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h2>शिक्षा सत्र <b>
                            <asp:Label ID="LblFyYear" runat="server"></asp:Label></b> के लिए मुद्रको को पुन: आवंटित पाठ्यपुस्तकों का डिपोवार आवंटन</h2>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                ...
                                <label id="Label4" runat="server">प्रति गड्डी पुस्तक संख्या</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                ...
                                <label id="Label2" runat="server">आर्डर नंबर</label>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="GrdVitranNirdesh" CssClass="table table-bordered hastable " AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <tr>
                        ...
                        <div>
                            <asp:Button ID="Button1" Visible="false" runat="server" Text="सम्बंधित डिपो भेजे एवं मुद्रक को प्रेषित करे" CssClass="btn" OnClick="Button1_Click" />
                        </div>
                    </div>
                </div>
            </div>
