<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DIB_012_TenderInformation_OLD.aspx.cs" Inherits="Paper_TenderRelatedInformation"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="box table-responsive">
        <div class="card-header">
            <h2>
                <span>
                    <%--Tender Related Information--%>बीमा टेंडर की जानकारी</span>
            </h2>
        </div>
        <div style="padding: 0 10px;">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBoxList ID="ddlDepo" runat="server">
                        </asp:CheckBoxList>
                    </td>
                    <td>
                        <%--Remark (--%>&#2335;&#2367;&#2346;&#2381;&#2346;&#2339;&#2368;
