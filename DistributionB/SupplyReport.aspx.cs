...
public partial class DistributionB_SupplyReport : System.Web.UI.Page
{
    DataSet ds;
    DataTable Dt, dt;
    ...
    private void FillReport()
    {
        ...
        Dt = comm.FillDatasetByProc("call USP_DepoWiseSupply( '" + ddlLetterNo.SelectedValue+ "')").Tables[0];
