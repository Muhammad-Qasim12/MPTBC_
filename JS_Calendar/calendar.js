...
function callCalendar(startyear,endyear,id_this,id) {
    setYears(startyear, endyear);
    showCalender(id_this, id);
}
...
{
	//targetEl = false ; //for enable keys in textbox
	targetEl = true;
	...
	//calTable.style.top = positions[1]+'px';         \\+ 25 px for showing dropdown under textbox 
