...
namespace MPTBCBussinessLayer.AcademicB
{
    public class Pri_BillDetails
    {
        ...
        public string AcadmicYR_V { get; set; }
        public int MasterUpdate()
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB011_BillDetailsSaveUpdate", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB011_BillDetailsSaveChildUpdate", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB011_BillDetailsFill", DBAccess.SQLType.IS_PROC);
