...
namespace MPTBCBussinessLayer.AcademicB
{
   public class PRI_CategoryMaster :ICommon
   {
       ...
       public int InsertUpdate()
       {
           ...
           obDBAccess.execute("USP_ACB005_CategoryMasterSave", DBAccess.SQLType.IS_PROC);
       ...
       {
           DBAccess obDBAccess = new DBAccess();
           obDBAccess.execute("USP_ACB005_CategoryMasterLoad", DBAccess.SQLType.IS_PROC);
           obDBAccess.addParam("mCatID_I", CatID_I);
       ...
       {
           DBAccess obDBAccess = new DBAccess();
           obDBAccess.execute("USP_ACB005_CategoryMasterDelete", DBAccess.SQLType.IS_PROC);
