...
namespace MPTBCBussinessLayer.AcademicB
{
    public class TenderDetails
    {
        ...
        public int InsertUpdate()
        {
            ...
            obDBAccess.execute("USP_ACB004_TenderDetailsSave", DBAccess.SQLType.IS_PROC);
            ...
            obDBAccess.addParam("LID", SqlDbType.Int, DBAccess.SqlDirection.OUT);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB004_TenderGroupDetailsLoad", DBAccess.SQLType.IS_PROC);
            obDBAccess.addParam("mTenderId_I", TenderId_I);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB004_TenderDelete", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB004_GetGroupDetailLoad", DBAccess.SQLType.IS_PROC);
            return obDBAccess.records();
        }
        public DataSet FillGridGroupDetail()
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB004_TenderGroupGridfill", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB004_TenderGroupDetailsSave", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACBLUNList", DBAccess.SQLType.IS_PROC);
            obDBAccess.addParam("mTender_ID", TenderId_I);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_ACB004_TenderEvalsave", DBAccess.SQLType.IS_PROC);
        ...
        public DataSet GetGrPID()
        {
            ...
            try
            {
                obDbaccess.execute("USP_ACB010_GroupIDGetByGrpName", DBAccess.SQLType.IS_PROC);
                obDbaccess.addParam("mGroupNO_V", GroupNM);
                ds = obDbaccess.records();
            }
        ...
        public int LunListExcelDataSave()
        {
            ...
            try
            {
                ...
                obDbaccess.execute("USP_ACB010_ExcelLunListSave", DBAccess.SQLType.IS_PROC);
        ...
        //// function for generate LOI USP_ACB004_FatchTenderprinterArrange call
        ...
        public int LOIGenrateprinterArrange()
        {
            ...
            try
            {
                obDbAccess.execute("USP_ACB004_FatchTenderprinterArrange", DBAccess.SQLType.IS_PROC);
                obDbAccess.addParam("macdmicyr_v", AcdmicYr_V);
        ...
        public int LOIGenrateAllot_ofprinter()
        {
            ...
            try
            {
                obDbAccess.execute("USP_ACB004_FatchTenderfinal_Allot_ofprinter", DBAccess.SQLType.IS_PROC);
                obDbAccess.addParam("macdmicyr_v", AcdmicYr_V);
                obDbAccess.addParam("pTenderid_i", TenderId_I);
        ...
        public DataSet LoadAllotedTenderList()
        {
            ...
            try
            {
                ObDbAccess.execute("USP_ACB004_TenderLOIData", DBAccess.SQLType.IS_PROC);
