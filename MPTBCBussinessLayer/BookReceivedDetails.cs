...
{
   public  class BookReceivedDetails :ICommon 
    {
        //,,,,,,,,,,,,,,,,,,
       ...
       public int ReceivedType_I { get { return _ReceivedType_I; } set { _ReceivedType_I = value; } }
      ...
      // ,,,,,,,,,,,,,,,,,,)
        ...
        public int InsertUpdate()
       {
           ...
           obDBAccess.execute("USP_DPT019_StockReceiveEntry_Save", DBAccess.SQLType.IS_PROC);
           ...
           obDBAccess.addParam("GRNo_V", GRNo_V);
           obDBAccess.addParam("GRDate_D", GRDate_D);
           ...
           obDBAccess.addParam("LordingCharge_N", LordingCharge_N);
           obDBAccess.addParam("unLordingCharge_N", unLordingCharge_N);
           ...
           obDBAccess.addParam("ReceivedType_I", ReceivedType_I);

           obDBAccess.addParam("BookType", BookType);
            
           obDBAccess.addParam("ReceviedBundleNo", LooseBookNo);
