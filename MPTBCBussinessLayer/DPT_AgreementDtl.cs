...
namespace MPTBCBussinessLayer
{
   public  class DPT_AgreementDtl
    {private int _LOITrId_I;
        ...
        public DPT_AgreementDtl(int userid)
        {
            _UserId_I = userid;
        ...
        public int InsertUpdate()
        {
            ...
            obDBAccess.execute("USP_DPT027_AgreementDetails", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_DPT027_DAgreementDetails", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_DPT_AgreementDetails", DBAccess.SQLType.IS_PROC);
