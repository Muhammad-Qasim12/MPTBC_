  ...
  public   class DPT_LOIDetails : ICommon
    {
        ...
        public float PBGAmount_N { get { return _PBGAmount_N; } set { _PBGAmount_N = value; } }
    ...
    public  DPT_LOIDetails(int userid )
        {
            _UserId_I = userid;
        ...
        public int InsertUpdate()
        {
            ...
            obDBAccess.execute("USP_DPT025_LOISaveUpdateData", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_DPT025_OIShowData", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_DPT025_LOIDeleteData", DBAccess.SQLType.IS_PROC);
