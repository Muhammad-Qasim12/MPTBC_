...
{
   public class BillProcess:ICommon
   {
       string
                _DepartmentName_V,
                _DeyakNo_V,
       ...
       public int InsertUpdate()
       {
           ...
           try
           {
               obDbaccess.execute("USP_LIB003_BillProcessInsertUpdate", DBAccess.SQLType.IS_PROC);
       ...
       public System.Data.DataSet Select()
       {
           ...
           try
           {
               ...
               obDbaccess.execute("USP_LIB003_BillProcessLoad", DBAccess.SQLType.IS_PROC);
