...
namespace MPTBCBussinessLayer
{
    public class PPR_PaperMaster : ICommon
    {
       // DataSet ds;
        ...
        private int _GSM;
        private string _PaperCategory;
        private float _PerSheetWt;

        public float PerSheetWt { get { return _PerSheetWt; } set { _PerSheetWt = value; } } 
        ...
        public int PaperTrId_I { get { return _PaperTrId_I; } set { _PaperTrId_I = value; } }
         ...
         public string PaperCategory { get { return _PaperCategory; } set { _PaperCategory = value; } }
         ...
         public int InsertUpdate()
         {
             ...
             obDBAccess.addParam("mPerSheetWt", PerSheetWt);
             obDBAccess.addParam("mPaperCategory", PaperCategory);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_PPR001_PaperMasterShowData", DBAccess.SQLType.IS_PROC);
            obDBAccess.addParam("mPaperType_Id", 0);
            obDBAccess.addParam("mtype", 0);
            return obDBAccess.records();
        }
        public System.Data.DataSet QualityTypeFill()
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_PPR001_PaperMasterShowData", DBAccess.SQLType.IS_PROC);
            obDBAccess.addParam("mPaperType_Id", PaperType_I);
            obDBAccess.addParam("mtype", 1);
            return obDBAccess.records();
        }
        public System.Data.DataSet SearchPaperName(string QualifyType)
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_PPR001_PaperMasterSearchName", DBAccess.SQLType.IS_PROC);
