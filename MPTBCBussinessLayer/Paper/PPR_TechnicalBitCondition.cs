...
{
    public class PPR_TechnicalBitCondition
    {
        ...
        public int InsertUpdate()
        {
            ...
            obDBAccess.execute("USP_PPR0023_TenderConditionSave", DBAccess.SQLType.IS_PROC);
        ...
        {
            DBAccess obDBAccess = new DBAccess();
            obDBAccess.execute("USP_PPR0023_TenderConditionLoadData", DBAccess.SQLType.IS_PROC);
