...
{
    public class Vehicle005_BillProcess : ICommon
    {
        string
                 _DepartmentName_V,
                 _DeyakNo_V,
        ...
        public int InsertUpdate()
        {
            ...
            try
            {
                obDbaccess.execute("USP_Vehicle005_VoucherSaveUpdate", DBAccess.SQLType.IS_PROC);
        ...
        public System.Data.DataSet Select()
        {
            ...
            try
            {
                ...
                obDbaccess.execute("USP_Vehicle005_VoucherLoad", DBAccess.SQLType.IS_PROC);
