<%@ Page Title="बचे हुये 8% पेमेंट की जानकारी / Information Of Remaining 8% Payment" Language="C#" MasterPageFile="~/MasterPage.master" 
    AutoEventWireup="true" CodeFile="RemainingEightPerPayment.aspx.cs" Inherits="Paper_RemainingEightPerPayment" %>


<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="portlet-header ui-widget-header">
        <%--Dispatch to C'Depot by Paper vendor--%> बचे हुये 8% पेमेंट की जानकारी / Information Of Remaining 8% Payment</div>
...
Acadmic Year :</td> <td colspan="3" style="height: 10px;" align="left"><asp:DropDownList ID="ddlAcYear" Width="250px" runat="server" OnInit="ddlAcYear_Init"></asp:DropDownList></td>
           ...
           कुल थब्बा निकलने की संभाबना (मे. टन)<br />Probability Of Defect(Metric Ton)
            ...
            <tr>
             ...
             <tr>
                <td colspan="4" style="font-size:15px;font-weight:bold;">
                पेपर मिल की 90% वाउचर की जानकारी / 90% Voucher Information Of Paper Mill
                </td>
            </tr>
            <tr>
                <td colspan="4" style="height: 10px;">
