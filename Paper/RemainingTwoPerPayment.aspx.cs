...
public partial class Paper_RemainingTwoPerPayment : System.Web.UI.Page
{
    DataSet ds;
    ...
    public void LabInvDtlFill()
    {
        ...
        ds = objPaperVoucharDetails.FiledFill2();
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void ddlVendor_SelectedIndexChanged(object sender, EventArgs e)
    {
      //  LOIFill();
        ...
        {
        DataSet ds1 = obCommonFuction.FillDatasetByProc("call USP_GetLoiByVendorandAcYear(" + ddlVendor.SelectedValue + ",'" + ddlAcYear.SelectedItem.Text + "')");
        ...
        else
        {
            ...
            try
            {
                ...
                if (ChkCdt == "Ok")
                {
                    ...
                    objPaperVoucharDetails.Payment10 = 2;
                    ...
                    if (Request.QueryString["ID"] == null)
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            lblThabba.Text = "0";
                            AutoSampleNo();
                            Response.Redirect("ViewRemainingTwoPerPayment.aspx");
    ...
    public void VoucherDtlBYLoi()
    {
        ...
        if (ddlVendor.SelectedItem.Text != "Select" && ddlLOINo.SelectedItem.Text != "Select")
        {
            ...
            ds = objPaperVoucharDetails.Vouchar2DtlFill();
            if (ds.Tables[0].Rows.Count > 0)
            {
