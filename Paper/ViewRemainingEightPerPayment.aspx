<%@ Page Title="बचे हुये 8% पेमेंट की जानकारी / Information Of Remaining 8% Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewRemainingEightPerPayment.aspx.cs" Inherits="Paper_ViewRemainingEightPerPayment" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="portlet-header ui-widget-header">
        <%--Dispatch to C'Depot by Paper vendor--%>
        बचे हुये 8% पेमेंट की जानकारी / Information Of Remaining 8% Payment
    </div>
                ...
                <table width="100%">
                    <tr>
                        <td style="text-align: left" width="20%">
                            <a class="btn" href="RemainingEightPerPayment.aspx">&#2344;&#2351;&#2366; &#2337;&#2366;&#2335;&#2366;
                                &#2337;&#2366;&#2354;&#2375; / New Entry</a>
                        </td>
                                    ...
                                    <asp:TemplateField HeaderText="डाटा में सुधार करे <br> Edit">
                                        <ItemTemplate>
                                            <asp:Panel ID="pnupdate" runat="server" Visible=' <%#Eval("Status").ToString().Equals("0")?true:false%>'>
                                                <a href="RemainingEightPerPayment.aspx?ID=<%# new APIProcedure().Encrypt( Eval("Vch_Trans_Id").ToString()) %>">डाटा में सुधार करे / Edit</a>
                                            </asp:Panel>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
