...
using System.Data;
public partial class Paper_ViewTenderInfo : System.Web.UI.Page
{
    ...
    public void GridFillLoad()
    {
        try
        {
            ...
            ds = objComm.FillDatasetByProc("call USP_ppr_TechniBidSearch('" + txtSearch.Text + "','" + ddlAcYear.SelectedItem.Value + "',8)");//objComm.FillDatasetByProc("call USP_PPR004_TenderInfoLoad(0,'" + ddlAcYear.SelectedItem.Value + "')");
    ...
    protected void ddlAcYear_Init(object sender, EventArgs e)
    {
        ...
        {/*
         ...
         //  ddlAcYear.Items.Insert(0, "सलेक्ट करे");
