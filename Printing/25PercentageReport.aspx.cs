...
public partial class Printing_25PercentageReport : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
          ...
          //  Label3.Text = ddlPrinter.SelectedItem.Text;
            ...
            DataSet ds = obCommanFun.FillDatasetByProc("call PrinterWise25percentageReport('" + Convert.ToDateTime(txtFromdate.Text, cult).ToString("yyyy-MM-dd") + "','" + Convert.ToDateTime(txtTodate.Text, cult).ToString("yyyy-MM-dd") + "', '" + Convert.ToInt32(Session["UserID"]) + "')");
