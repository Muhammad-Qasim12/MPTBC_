...
using System.Data;
public partial class Printing_OtherThenTextbookPrinterChallanRpt : System.Web.UI.Page
{
    CommonFuction obCommonFuction = new CommonFuction();
    public DataSet ds1;
    protected void Page_Load(object sender, EventArgs e)
    {
        ds1 = obCommonFuction.FillDatasetByProc("call USP_Prin_ChallanReport_acb(0," + Request.QueryString["ID"].ToString() + ")");
        if (!IsPostBack)
        {
            try
            {
