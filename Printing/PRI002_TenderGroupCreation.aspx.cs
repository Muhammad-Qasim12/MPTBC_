...
public partial class Printing_Text : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            load();
            lblacdyr.Text = obCommonFunction.GetFinYear();
        }
    ...
    public void LoadGrid(int status)
    {
        ...
        finally
        {
            ...
            obCommonFunction = null;
        }

    }


    public void LoadTitilewiseGrid(int status)
    {
        CommonFuction obCommonFunction = new CommonFuction();
        obGroupCreation = new PRI_GroupCreation();
        ...
        try
        {
            ...
            {
                obGroupCreation.TitleID_I = Convert.ToInt32(ddlTitle.SelectedValue);
            }
            else
            {
                obGroupCreation.TitleID_I = 0;
            }


            if (ddlClass.SelectedIndex > 0)
            {
                obGroupCreation.ClassID_I = Convert.ToInt32(ddlClass.SelectedValue);
            }
            else
            {
                obGroupCreation.ClassID_I = 0;
            }
            ...
            if (status == 0)
            {
                ...
                grdBooksDes.DataSource = obGroupCreation.LoadGridTitleView();
                grdBooksDes.DataBind();
