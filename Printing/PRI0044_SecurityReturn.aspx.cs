...
public partial class Printing_PRI0044_EMDTransfer : System.Web.UI.Page
{
    ...
    protected void btnclose_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VIEW_TenderDetailsfinance.ASPX?ACYear=" + Session["finyear"].ToString()  + "");  
    }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
    {
     ...
     Response.Redirect("VIEW_TenderDetailsfinance.ASPX?ACYear=" + finyear + "");  
        // GridFill();
    ...
    {
        Response.Redirect("VIEW_TenderDetailsfinance.ASPX");  
    }
