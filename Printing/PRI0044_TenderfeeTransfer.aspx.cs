...
public partial class Printing_PRI0044_TenderFeeTransfer : System.Web.UI.Page
{
    ...
    protected void btnclose_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VIEW_TenderfeeDetailsfinance.ASPX?ACYear=" + Session["finyear"].ToString()  + "");  
    }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
    {
     ...
     Response.Redirect("VIEW_TenderFeeDetailsfinance.ASPX?ACYear=" + finyear + "");  
        // GridFill();
    ...
    {
        Response.Redirect("VIEW_TenderFeeDetailsfinance.ASPX");  
    }
    ...
    public class PRI_TenderEvaluation 
    {
        ...
        public int EMDSave()
        {
            ...
            try
            {
                ...
                obDbaccess.addParam("mEMDDetail", "");
                obDbaccess.addParam("mMRNo", "" );
                obDbaccess.addParam("mMRDate", "" );
                obDbaccess.addParam("mstatus",0);
                obDbaccess.addParam("mfee",EMD);
                obDbaccess.addParam("mMRNofee",MRno);
                obDbaccess.addParam("mMRDatefee",MRdate);
                obDbaccess.addParam("mType", 2);

                // EMD used for fee amount
