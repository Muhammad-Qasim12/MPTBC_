...
public partial class Printing_PaperAllotmentReturn : System.Web.UI.Page
{
    ...
    public void ddlFill()
    {
        try
        {
           ...
           /* acd_titledetail.DataSource = obCommonFuction.FillDatasetByProc("CALL USP_ADM015_AcadmicYearLoad(0)");
            ...
            acd_titledetail.DataTextField = "AcYear";
            acd_titledetail.DataBind();
            acd_titledetail.SelectedValue = obCommonFuction.GetFinYearNew();
            acd_titledetail.Items.Insert(0, "सलेक्ट करे");*/
    ...
    protected void ddlPrinterName_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        {
            CommonFuction comm = new CommonFuction();
            DataSet ds4 = comm.FillDatasetByProc("call GetPrintigandPaperSec(" + ddlPrinterName.SelectedValue + ",'" + acd_titledetail.SelectedItem.Text + "')");
            try
            {
