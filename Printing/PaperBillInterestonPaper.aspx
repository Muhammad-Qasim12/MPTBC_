<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PaperBillInterestonPaper.aspx.cs" Inherits="Printing_PaperBillInterestonPaper" %>
    ...
    <div class="box table-responsive">
        <div class="card-header">
            <h2 style="text-align: center">
                <span>Interest on Paper  <%--FINAL PAYMENT FOR THE YEAR - 2014-2015--%></span></h2>
        </div>
                ...
                <table width="100%">
                    <tr>
                        ...
                        &#2358;&#2376;&#2325;&#2381;&#2359;&#2339;&#2367;&#2325; &#2360;&#2340;&#2381;&#2352; / Academic Year
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlAcadmicYear" runat="server" CssClass="txtbox reqirerd">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                        ...
                        &#2344;&#2366;&#2350; / Name of the Printer
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPrinterName" runat="server" CssClass="txtbox reqirerd" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        Challan Upto Date</td>
                                    <td>
                            ...
                            <cc1:CalendarExtender ID="txtChalanrecDate_CalendarExtender" runat="server" Format="dd/MM/yyyy" TargetControlID="txtChalanrecDate">
                                    ...
                                    <td>
                                        <asp:LinkButton ID="BtnGetReport"
                                            Text="Get Details"
                                            runat="server" CssClass="btn" ForeColor="White" OnClick="BtnGetReport_Click"></asp:LinkButton>
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:GridView ID="GrdPaperBill" runat="server" AutoGenerateColumns="False" CssClass="tab" DataKeyNames="PriTransID"
                            ...
                            <asp:LinkButton ID="BtnCalculate"
                                Text="Calculate"
                                runat="server" CssClass="btn" ForeColor="White" OnClick="BtnCalculate_Click"></asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:GridView ID="GrdBillIntrast" runat="server" AutoGenerateColumns="False" OnRowDataBound="GrdBillIntrast_RowDataBound" 
                                CssClass="tab" DataKeyNames="PriTransID" ShowFooter="true" AllowPaging="false">
                                <Columns>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:LinkButton ID="lbSaveDetails"
                                Text="Save"
                                runat="server" CssClass="btn" ForeColor="White" OnClick="lbSaveDetails_Click" ></asp:LinkButton>
                             <br />
                        </td>
                    </tr>
                </table>
