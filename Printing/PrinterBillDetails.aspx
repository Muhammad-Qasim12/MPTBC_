<%@ Page Title="बिल की जानकारी" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="PrinterBillDetails.aspx.cs" Inherits="Printing_PrinterBillDetails" %>
        ...
        <ContentTemplate>
                ...
                <div class="card-body">
                    ...
                    <asp:Panel runat="server" ID="pnlMain">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <asp:TextBox ID="txtChalanrecDate" runat="server" TextMode="Date" CssClass="form-control reqirerd" MaxLength="10" onkeypress="tbx_fnAlphaNumericOnly(event, this);"></asp:TextBox>
                                    ...
                                    <label>Add Challan Received upto Date</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <asp:DropDownList ID="ddlPrinter" runat="server" AutoPostBack="True" CssClass="form-select reqirerd" OnInit="ddlPrinter_Init" OnSelectedIndexChanged="ddlPrinter_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <label>Name of the Printer</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <asp:TextBox ID="txtBillNo" runat="server" CssClass="form-control reqirerd" MaxLength="10" onkeypress="tbx_fnAlphaNumericOnly(event, this);"></asp:TextBox>
                                    <label>Bill No.</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <asp:TextBox ID="txtBillDate" runat="server" CssClass="form-control reqirerd" MaxLength="10" onkeypress="tbx_fnAlphaNumericOnly(event, this);" AutoPostBack="True" OnTextChanged="txtBillDate_TextChanged"></asp:TextBox>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <table width="100%" class="table table-bordered">
                                    <tr>
                                        <td colspan="4">(A) Payable Amount
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">(1) Paper supplied size 84cm
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtTotalPaperSupply" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>0</asp:TextBox>
                                        </td>
                                        <td>Total Cover Paper supplied
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtTotalCoverPaperSupply" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>0</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>(ii) Paper Security deposited by the printer Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtPaperSecurityDeposit" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>0</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>(iii) Paper Security reimbursed to the printer Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtPaperSecurityReimbursed" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>0</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>(iv) Balance paper Security for reimbursement Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtBalancePaperSecurityReimbursed" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>0</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">(2) Printing charges, Paper & Cover paper consumptions
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <asp:GridView runat="server" ID="GrdPaperCoverAndPrintingChares" AutoGenerateColumns="False"
                                                CssClass="table table-bordered" OnRowDataBound="GrdPaperCoverAndPrintingChares_RowDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Rate">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="lblRate_N" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtAmount1_TextChanged"
                                                    ...
                                                    <asp:TemplateField HeaderText="No of Library Books ">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtLibBook" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtLibBook_TextChanged"
                                                    ...
                                                    <asp:TemplateField HeaderText="Blank Pages(per Book)">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtBlankPages" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtBlankPages_TextChanged"
                                                    ...
                                                    <asp:TemplateField HeaderText="Paper consumption with wastage in Tons">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPapterConsumption" CssClass="form-control" runat="server" MaxLength="8"
                                                    ...
                                                    <asp:TemplateField HeaderText="Cover Paper consumption with wastage in Sheets">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtCoverPapterConsumption" CssClass="form-control" runat="server" MaxLength="8"
                                                    ...
                                                    <asp:TemplateField HeaderText="Bad Printing Penalty(%)">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtBadPrintPen_grd" CssClass="form-control" runat="server" MaxLength="8" AutoPostBack="true"
                                    ...
                                    <tr>
                                        <td>Total 100% Printing Charges Rs.
                                        </td>
                                        <td colspan="3">
                                            <asp:TextBox runat="server" ID="txtPrintingCharge" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>0</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>25% Printing Charges to be withheld Rs.
                                        </td>
                                        <td colspan="3">
                                            <asp:TextBox runat="server" ID="txtPrintingCharge25Per" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>0</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>75% Printing Charges Payable Rs.
                                        </td>
                                        <td colspan="3">
                                            <asp:TextBox runat="server" ID="txtPrintingCharge75Per" CssClass="form-control reqirerd"
                                                MaxLength="8"
                            ...
                            <asp:RadioButton ID="rdIn" runat="server" GroupName="rd" Text="Within M.P. Printer" Checked="true" onclick="javascript:chkgst();" OnCheckedChanged="rdIn_CheckedChanged" AutoPostBack="True" />
                                        ...
                                        <td>
                                            <div id="dvOutgst" runat="server" clientidmode="Static" style="line-height: 1.5em; display: none;">
                                                IGST (5%) :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:Label ID="lblOutgst" runat="server"></asp:Label>
                                            </div>
                                            <div id="dvIngst_s" runat="server" clientidmode="Static" style="line-height: 1.5em;">
                                                CGST (2.5%) :&nbsp;&nbsp;&nbsp;
                                        <asp:Label ID="lblIngst_s" runat="server"></asp:Label>
                                            </div>
                                            <div id="dvIngst_c" runat="server" clientidmode="Static" style="line-height: 1.5em;">
                                                SGST (2.5%) : &nbsp;&nbsp;&nbsp;
                                        <asp:Label ID="lblIngst_c" runat="server"></asp:Label>
                                            </div>
                                        </td>
                                        <td>&nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <asp:TextBox ID="txtReimburseAmount" runat="server" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress="javascript:tbx_fnSignedNumeric(event, this);" AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtPaperSecurityFor" runat="server" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress="javascript:tbx_fnSignedNumeric(event, this);"
                                                Visible="False">0</asp:TextBox>
                                            <asp:TextBox ID="txtReemPaperRs" runat="server" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress="javascript:tbx_fnSignedNumeric(event, this);"
                                                Visible="False">0</asp:TextBox>
                                            <asp:TextBox ID="txtTonsPerReem" runat="server" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress="javascript:tbx_fnSignedNumeric(event, this);"
                                                Visible="False">0</asp:TextBox>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtPayBlePrintingCharg" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtTotalPaybleAmount" CssClass="form-control reqirerd"
                                                MaxLength="8"
                            ...
                            <asp:Panel runat="server" ID="Panel2" GroupingText="DEDUCTIONS" Style="font-size: 13px;" Width="1200px">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>(1) Withheld 2% regarding income Tax on Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txt2PerInComeTAX" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td>&nbsp;<asp:Label ID="lblTDSGST" runat="server" Text="(2-a) Withheld 1% regarding SGST TDS Rs. "></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txt2PerTDSGST" runat="server" AutoPostBack="True" CssClass="form-control reqirerd" Enabled="true" MaxLength="8" onkeypress="javascript:tbx_fnSignedNumeric(event, this);" OnTextChanged="txt2PerInComeTAX_TextChanged">0</asp:TextBox>
                                        </td>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt2PerTDSCGST" runat="server" AutoPostBack="True" CssClass="form-control reqirerd" Enabled="true" MaxLength="8" onkeypress="javascript:tbx_fnSignedNumeric(event, this);" OnTextChanged="txt2PerInComeTAX_TextChanged">0</asp:TextBox>
                                        </td>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDeductionPaperSecurity" runat="server" AutoPostBack="True" CssClass="form-control reqirerd" MaxLength="8" onkeypress="javascript:tbx_fnSignedNumeric(event, this);" OnTextChanged="txtDeductionPaperSecurity_TextChanged">0</asp:TextBox>
                                        </td>
                                        <td colspan="2"></td>
                                    </tr>
                                    <tr>
                                        <td>(4) Depot Expenditure on behalf of Printer
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtDepotExpenditure" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td class="auto-style1">(5) Interest on Paper
                             
                                        </td>
                                        <td class="auto-style1">
                                            <asp:TextBox runat="server" ID="txtPaperInterest" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td>(6) Penalty for Delay supply of Books
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtDelaySupplyPenalty" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td>(7) Deduction of Paper cost of against short size of Books
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtShortSizeBookDeduction" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtBadPrinting" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td>(9) Printing Mistakes
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtPrintingMistakes" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtLamination" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td>(11) Perfect Binding
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtPerfectBinding" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td>(12) Loose Bundle Pack
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtLooseBundlePack" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td>(13) Transportation/Delievery charges
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtTransportationDelvry" CssClass="form-control reqirerd"
                                                MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' AutoPostBack="True"
                                    ...
                                    <tr>
                                        <td style="vertical-align: middle;">(14) Other Deduction : Description
                             <div style="margin-left: 20px; text-align: left; padding-top: 8px">
                                 <asp:TextBox runat="server" ID="txtOtherDedDescription" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                             </div>
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtOtherDedAmt" CssClass="form-control reqirerd" MaxLength="8"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtBFPay" runat="server" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress="javascript:tbx_fnSignedNumeric(event, this);"
                                                Visible="False">0</asp:TextBox>
                                            <asp:TextBox runat="server" ID="txtRs2" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);'
                                                Visible="False">0</asp:TextBox>
                                            <asp:TextBox runat="server" ID="txtRs3" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);'
                                                Visible="False">0</asp:TextBox>
                                        </td>
                                        <td>(B) Total deduction
                                        </td>
                                        <td>Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtTotalDeduction" CssClass="form-control reqirerd" MaxLength="8"
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>(C) Net payable A-B
                                        </td>
                                        <td>Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtNetPayable" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' Enabled="false">0</asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>Amount return to Printer
                                        </td>
                                        <td>Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtAmtReturnToPrinter" CssClass="form-control reqirerd" MaxLength="8"
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td>
                                            <b>Rs.</b>
                                            <asp:Label runat="server" ID="lblGSTAmt" Font-Bold="true">0</asp:Label>
                            ...
                            <asp:Panel runat="server" ID="pnlPrintingSection" Style="font-size: 13px;" GroupingText="Printing Section"
                                ...
                                <table>
                                    <tr>
                                        <td>(a) Amount of the Bill Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtBillAmount" CssClass="form-control reqirerd" MaxLength="8"
                                                onkeypress='javascript:tbx_fnSignedNumeric(event, this);' Enabled="false">0</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>(b) Amount of the Deduction Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtBillAmountofDeduction" CssClass="form-control reqirerd"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtBillNetPayablePrinting" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);' Enabled="false">0</asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" ID="txtGST" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);' Enabled="false">0</asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAmtReturnToPrinter0" runat="server" CssClass="form-control reqirerd" MaxLength="8" onkeypress="javascript:tbx_fnSignedNumeric(event, this);">0</asp:TextBox>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td>(f) Total Payable Amount including GST (c + d + e) Rs.
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtTotalPayableWithGST" CssClass="form-control reqirerd"
                                                MaxLength="8" onkeypress='javascript:tbx_fnSignedNumeric(event, this);' Enabled="false">0</asp:TextBox>
                                        </td>
                            ...
                            <div class="col-md-12">
                                <asp:Button runat="server" ID="btnForward" CssClass="btn btn-submit" Text="Save" OnClientClick="return ValidateAllTextForm();"
                                OnClick="btnForward_Click" />
                            <asp:Button ID="btnBack" runat="server" Text="Back" OnClick="btnBack11_Click" CssClass="btn btn-default" />
                            </div>
                ...
                <asp:Panel runat="server" ID="pnlChequeIssue" Style="font-size: 13px;" GroupingText="Bank Details" Width="1200px" CssClass="PanelPadding" Visible="false">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtBankName" CssClass="form-control reqirerd" MaxLength="200"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtChequeDDNo" CssClass="form-control reqirerd" MaxLength="12"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtChequeDate" CssClass="form-control reqirerd"></asp:TextBox>
                        ...
                        <tr>
                            <td>(d) Cheque Amount of the Bill Rs.
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="txtCheckAmount" CssClass="form-control reqirerd" onkeypress='javascript:tbx_fnSignedNumeric(event, this);'>
                                </asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtCheckRemark" CssClass="form-control" TextMode="MultiLine" MaxLength="500"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
            ...
            <div id="MessagesGroup" style="display: none; width: 80%; left: 5%" class="popupnew" runat="server">
                ...
                <div style="float: right;">
                    <asp:LinkButton ID="LinkButton7" runat="server" OnClientClick="javascript:return PrintPanel_interest();">&#2346;&#2381;&#2352;&#2367;&#2306;&#2335;..</asp:LinkButton>
                </div>
                <table width="100%">
                    <tr>
            ...
            <div id="Div1" style="display: none; width: 80%; left: 5%" class="popupnew" runat="server">
                ...
                <div style="float: right;">
                    <asp:LinkButton ID="lnkPriShortbook" runat="server" OnClientClick="javascript:return PrintPanel_agstshortbook();">&#2346;&#2381;&#2352;&#2367;&#2306;&#2335;..</asp:LinkButton>
                </div>
            ...
            <div id="Div3" style="display: none; width: 80%; left: 5%" class="popupnew" runat="server">
                <asp:Panel ID="Panel4" runat="server" Height="400px" ScrollBars="Both">
                    ...
                    <div style="float: right;">
                        <asp:LinkButton ID="lnkPrint22" runat="server" OnClientClick="javascript:return PrintPanel_delay();">&#2346;&#2381;&#2352;&#2367;&#2306;&#2335;..</asp:LinkButton>
                    </div>
                    <table width="100%">
                        <tr>
            ...
            <div id="Messages11" style="display: none;" class="popupnew" runat="server">
                <div class="card">
                    <div class="card-header">
                        Paper Issue Quantity Detail
                    </div>
                    <div class="card-body">
                                                    ...
                                                    <table class="tab" border="1" style="border-collapse: collapse;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="background-color: lightgrey; border-color: black; border-width: 1px; border-style: solid; font-size: 1em;"></th>
                                                                <th colspan="2" style="text-align: center; vertical-align: middle; background-color: lightgrey; border-color: black; border-width: 1px; border-style: solid; font-size: 1em;">Paper Qty(Ton)
                                                                </th>
                                                                <th colspan="2" style="text-align: center; vertical-align: middle; background-color: lightgrey; border-color: black; border-width: 1px; border-style: solid; font-size: 1em;">Cover Paper Qty(Sheet)
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <ItemTemplate>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em;">
                                                                <asp:Label ID="lblGSM70" runat="server" Text='<%#Eval("GSM70")%>'></asp:Label></td>
                                                            <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em;">
                                                                <asp:Label ID="lblGSM80" runat="server" Text='<%#Eval("GSM80")%>'></asp:Label></td>
                                                            <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em;">
                                                                <asp:Label ID="lblGSM230" runat="server" Text='<%#Eval("GSM230")%>'></asp:Label></td>
                                                            <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em;">
                                                                <asp:Label ID="lblGSM250" runat="server" Text='<%#Eval("GSM250")%>'></asp:Label></td>
                                                        </tr>
                                                    </tbody>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <tr>
                                                        ...
                                                        <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em; font-weight: bold;">
                                                            <div style="padding: 0 0 5px 0; font-weight: bold;">
                                                                <asp:Label ID="lbl70GSMPaperTotal" runat="server" />
                                                            </div>
                                                        </td>
                                                        <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em; font-weight: bold;">
                                                            <div style="padding: 0 0 5px 0; font-weight: bold;">
                                                                <asp:Label ID="lbl80GSMPaperTotal" runat="server" />
                                                            </div>
                                                        </td>
                                                        <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em; font-weight: bold;">
                                                            <div style="padding: 0 0 5px 0; font-weight: bold;">
                                                                <asp:Label ID="lbl230GSMCoverPaperTotal" runat="server" />
                                                            </div>
                                                        </td>
                                                        <td style="border-color: black; border-width: 1px; border-style: solid; font-size: 1em; font-weight: bold;">
                                                            <div style="padding: 0 0 5px 0; font-weight: bold;">
                                                                <asp:Label ID="lbl250GSMCoverPaperTotal" runat="server" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </table>
                        ...
                        <div class="col-md-12 text-center">
                            <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-primary" OnClick="lnBtnBack11_Click">बंद करें</asp:LinkButton>
                            <asp:LinkButton ID="lnkPrint11" runat="server" CssClass="btn btn-dark" OnClientClick="javascript:return PrintPanel();">प्रिंट करें</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
