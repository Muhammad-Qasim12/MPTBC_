<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DailyBookSupplySalesReportMDFinal_New.aspx.cs" Inherits="DailyBookSupplySalesReportMDFinal_New" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tr>
            ...
            <td>
                <asp:RadioButton ID="rdDistrict" runat="server" Text="District" GroupName="rd" Checked="true" />
                <asp:RadioButton ID="rdBlock" runat="server" Text="Block" GroupName="rd" />
            </td>
            <td>
