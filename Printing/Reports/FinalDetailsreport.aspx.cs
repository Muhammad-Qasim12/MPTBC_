...
public partial class Depo_FinalDetailsreport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DataSet dsGSR = cmd.FillDatasetByProc("call USP_DPTFinalCountingPrinting(" + Session["UserID"] + ",'" + Convert.ToDateTime(Request.QueryString["Fromdate"], cult).ToString("yyyy-MM-dd") + "','" + Convert.ToDateTime(Request.QueryString["Todate"], cult).ToString("yyyy-MM-dd") + "','" + Request.QueryString["ID"] + "')");
          ...
          ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Printing/Reports/RptFinalReport.rdlc");
