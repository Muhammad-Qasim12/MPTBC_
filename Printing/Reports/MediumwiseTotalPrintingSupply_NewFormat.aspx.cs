...
public partial class Printing_Reports_MediumwiseTotalPrintingSupply : System.Web.UI.Page
{
    ...
    protected void BtnShow_Click(object sender, EventArgs e)
    {
        ...
        Dt = obCommonFuction.FillTableByProc("Call USP_RPT009_GetMediumwiseAvantanReceiveddetail_ByBookStatus_TEST('" + finYr + "','" + DdlMedium.SelectedValue + "','" + DdlDepo.SelectedValue + "','" + ClassID + "','1900-01-01')");
        ...
        if (Dt.Rows.Count > 0)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Printing/Reports/ReportMediumwiseBooksAllotmentMtxRpt_NewFormat.rdlc");
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportParameter[] Param = new ReportParameter[2];
            Param[0] = new ReportParameter("Year", finYr);
            string Title = "";
            Title = "डिपो : " + DdlDepo.SelectedItem.Text.ToString().Replace("All", "सभी") + ", " + " माध्यम : " + DdlMedium.SelectedItem.Text.ToString().Replace("All", "सभी") + ", कक्षा: " + DropDownList1.SelectedItem.Text.ToString().Replace("All", "सभी") ;
