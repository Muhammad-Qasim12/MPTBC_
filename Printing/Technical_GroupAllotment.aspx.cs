...
public partial class Printing_TechnicalBidAllot : System.Web.UI.Page
{
...
public  String printername1;
    ...
    private int ImportTogridbytbl()
    {
        ...
        // ds1 = comm.FillDatasetByProc("call USP_LunListNew_Allotment(" + Convert.ToInt32(objapi.Decrypt(Request.QueryString["TenderId"]).ToString()) + ")");
        ds1 = comm.FillDatasetByProc("call USP_LunListNew_Allotment(0)");
                ...
                if (TEval != 0)
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                      ...
                      //  CALL USP_PrinterGroupValidationforLUN('2017-2018',mprinterid,'S' );
                        CommonFuction comm = new CommonFuction();
                        DataSet ds1 = new DataSet();
                         ds1 = comm.FillDatasetByProc("call USP_PrinterGroupValidationforLUN('2017-2018'," + Convert.ToInt32(PriId) + ",'S')");
                      //  GrdEval.DataSource = ds1.Tables[1]; ;
                      //  GrdEval.DataBind();
                    }
                }
  ...
  //  TextBox3.Text = "";
    ...
    for (int i = 0; i < GridView3.Rows.Count; i++)
    {
        try
        {
            ...
            else if (groupcolor.ToUpper().ToString() == "TWO")
            {
