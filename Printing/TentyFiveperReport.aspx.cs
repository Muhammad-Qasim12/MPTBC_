    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            */
            ...
            {
            PrinID=ddlPrinter.SelectedValue;
            }
            DataSet ds = obCommanFun.FillDatasetByProc("call USP_DPTTwentyFiveReportPrinting('" + Convert.ToDateTime(txtFromdate.Text, cult).ToString("yyyy-MM-dd") + "','" + Convert.ToDateTime(txtTodate.Text, cult).ToString("yyyy-MM-dd") + "', '" + Convert.ToInt32(Session["UserID"]) + "'," + PrinID + ",'"+DdlACYear.SelectedItem.Text+"')");
