...
public partial class Printing_ViewBillDetails : System.Web.UI.Page
{
    DataSet ds;
    ...
    public void LoadAllBillDetails(string BillID)
    {
        try
        {
            ...
            objBillDetails.BillDate_D = DateTime.Parse("2017-07-27");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtLekhaSheersh_V.Text = "Printing Charges Payable";

                txtSanctionedAmount_N.Text = ds.Tables[0].Rows[0]["PrnChrg75per_N"].ToString();
                ...
                txtPayAmount_N.Text = ds.Tables[0].Rows[0]["TotAmtPayableWithGST_N"].ToString();
                ...
                txtSamayojanAmount_N_Account.Text = ds.Tables[0].Rows[0]["TotalDed_N"].ToString();
                txtPayAmount_N_Account.Text = ds.Tables[0].Rows[0]["TotAmtPayableWithGST_N"].ToString(); 
    ...
    public void GridFillLoad()
    {
        try
        {
            ...
            {
                if ( hfLoggedInDeptName.Value == "Printing")
                {
                    //hfApprovedFlag.Value == "सहायक ग्रेड-2" &&
                    GrdLabMaster.Columns[8].Visible = true;
                }
                else
                    GrdLabMaster.Columns[8].Visible = false;
            }
        }
        catch { }
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else if (int.Parse(hdnVchrStatus.Value) >= 1)
            {
                ...
                else
                {
                    ...
                    ltrView.Text = "प्रिंटिंग बिल को आगे भेजा गया";
                }
            }
    ...
    public int SaveVoucher(string DesignationId, string DepartmentId)
    {
        ...
        else
        {
            try
            {
                ...
                obVoucher.SanctionedAmountByBranchOfficer_N = Convert.ToDouble(txtSanctionedAmount_N.Text);
