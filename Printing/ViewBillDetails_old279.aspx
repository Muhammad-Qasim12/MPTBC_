<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewBillDetails_old279.aspx.cs" Inherits="Printing_ViewBillDetails_old279" %>
                ...
                <tr>
                    <td style="text-align: left">
                        <table>
                            <tr>
                                <td>
                                    <a href="PRI003_BillDetails.aspx">
                                        <div class="btn">
                                            &#2344;&#2351;&#2366; &#2337;&#2366;&#2335;&#2366; &#2337;&#2366;&#2354;&#2375;</div>
                                    </a>
                                ...
                                <asp:TemplateField HeaderText="&#2337;&#2366;&#2335;&#2366; &#2350;&#2375;&#2306; &#2360;&#2369;&#2343;&#2366;&#2352; &#2325;&#2352;&#2375;">
                                 ...
                                 <asp:TemplateField HeaderText="View Bill">
                                    <ItemTemplate>                                        
                                        ...
                                        <a href="../Printing/PRI003_BillDetails.aspx?ID=<%#new APIProcedure().Encrypt(Eval("BillID_I").ToString()) %>&vw=1">&#2342;&#2375;&#2326;&#2375;&#2306;</a>
                                       </asp:Panel>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Voucher Information">
                                    <ItemTemplate>                                                                                
                                        ...
                                        <a href="../PRI003_CreateVoucher.aspx?BillID=<%#new APIProcedure().Encrypt(Eval("BillID_I").ToString())%>&vw=<%#new APIProcedure().Encrypt("Printing")%>&BillID11=<%#new APIProcedure().Encrypt(Eval("BillID_I").ToString())%>">Create Voucher</a>&nbsp;|&nbsp;
                                            <asp:LinkButton ID="lnktitleBill55" CommandName="Printing" CommandArgument='<%#Eval("BillID_I")%>' runat="server" OnClick="lnkForwardBill_Click" Text='Forward'></asp:LinkButton>
                                        </asp:Panel>
                                        ...
                                        <a href="../PRI003_CreateVoucher.aspx?Cid=<%#new APIProcedure().Encrypt(Eval("VoucherID").ToString())%>&vw=<%#new APIProcedure().Encrypt("Printing")%>&BillID11=<%#new APIProcedure().Encrypt(Eval("BillID_I").ToString())%>&b=e&desg11=<%#new APIProcedure().Encrypt(Eval("ApprovedBy").ToString())%>">Edit Voucher</a>
                                         ...
                                         <asp:Panel ID="pnlViewV" runat="server" Visible="false">
                                             <a href="../PRI003_CreateVoucher.aspx?Cid=<%#new APIProcedure().Encrypt(Eval("VoucherID").ToString()) %>&vw=<%#new APIProcedure().Encrypt("Printing")%>&id=<%#new APIProcedure().Encrypt("0")%>&b=bill">View Voucher</a>
                                        </asp:Panel>
                                    </ItemTemplate>
                                </asp:TemplateField>
