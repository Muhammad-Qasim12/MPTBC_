...
public partial class Printing_ViewBillDetails_old279 : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "msg11", "alert('Voucher saved successfully.');", true);
