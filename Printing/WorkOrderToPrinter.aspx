<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WorkOrderToPrinter.aspx.cs" Inherits="Printing_WorkOrderToPrinter" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card">
        <div class="card-header">
            <h2>प्रिंटर को कार्यादेश जारी करे</h2>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-floating">
                        <asp:TextBox ID="txtLOIDate_D" runat="server" MaxLength="10" TextMode="Date" CssClass="form-control reqirerd"></asp:TextBox>
                        <label>एल.ओ.आई. दिनांक</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-floating">
                        <asp:TextBox ID="txtWorkorderNo_V" runat="server" MaxLength="12" placeholder="txtWorkorderNo_V" CssClass="form-control reqirerd"></asp:TextBox>
                        <label>कार्यादेश क्रमांक</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-floating">
                        <asp:TextBox ID="txtWODate_D" runat="server" TextMode="Date" MaxLength="10" placeholder="txtWODate_D" CssClass="form-control reqirerd"></asp:TextBox>
                ...
                <div class="col-md-4">
                    <div class="form-floating">
                        <asp:TextBox ID="txtPaperSecAmt" runat="server" MaxLength="15" placeholder="txtPaperSecAmt" CssClass="form-control reqirerd"></asp:TextBox>
                ...
                <div class="col-md-4">
                    <div class="form-floating">
                        <asp:TextBox ID="txtPrintingSecAmt" runat="server" MaxLength="15" placeholder="PrintingSecAmt" CssClass="form-control reqirerd"></asp:TextBox>
                ...
                <div class="col-md-12">
                    ...
                    <asp:GridView ID="GrdGroupDetails" runat="server" AutoGenerateColumns="False"
                            CssClass="table table-bordered table-hover" DataKeyNames="GRPID_I"
                            OnRowDataBound="GrdGroupDetails_RowDataBound" PageSize="25">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="मुद्रण दर  (रुपये मे)/Amount (Rs)" DataField="rate" />
