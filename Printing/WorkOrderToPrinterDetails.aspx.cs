...
public partial class Printing_WorkOrderToPrinterDetails : System.Web.UI.Page
{
    ...
    public void GetDataBYAcYear()
    {
        ...
        if (ddlPrinter.SelectedIndex > 0)
        {
            ...
            PrinterName = ddlPrinter.SelectedItem.Text;
        }
        else
        {
            PrinterName = "";
        ...
        ddS = obCommonFuction.FillDatasetByProc("call USP_PRI011_WorkOrderDetailLoadSearchNew('" + PrinterName + "','" + DdlACYear.SelectedItem.Text + "','" + ddlTenderID_I.SelectedItem.Text + "')"); ;
        //ddlTenderID_I.DataSource = dd.Tables[0];
