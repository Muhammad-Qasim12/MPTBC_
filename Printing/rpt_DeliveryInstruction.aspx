<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="rpt_DeliveryInstruction.aspx.cs"   EnableEventValidation="false"
    Inherits="Printing_rpt_DeliveryInstruction" %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td style="font-size: medium;" valign="middle">
                        ...
                        <asp:DropDownList ID="DdlACYear" Width="100px" runat="server" CssClass="txtbox reqirerd">
                        </asp:DropDownList>
                    </td>
                                        ...
                                        <div id="ExportDiv" runat="server">
                                            <div style="width: 100%; border: 1px solid #ccc; margin-top: 40px;">
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="4" style="font-size: 16px; font-weight: 200; text-align: center;">&quot; प्रिंटर &quot;
                                                        </td>
                                                    </tr>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 60px">
                                                                                   ...
                                                                                   <%-- <asp:LinkButton Text="प्रिंट / Print " ID="Viewbarcode" runat="server" OnClientClick="return Redirect(this);"></asp:LinkButton>
                                                                                </td>--%>
