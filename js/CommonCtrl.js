...
function tbx_fnAlphaNumericOnlyOnBlur(ctrl)
{   //.:46, >:62, ,:44,
    var text=ctrl.value;
    var iCount=0;
    var bInvalid=0;
...
function tbx_fnAlphaNumeric(e, ctrl)
{   //.:46, >:62, , :44, #:35
    if (!e) e=window.event;
    if (e.charCode)
    {
        if ((e.charCode<48 || (e.charCode>57 && e.charCode<65) || (e.charCode>90 && e.charCode<97) || e.charCode>122) && e.charCode!=95 && e.charCode!=32)
        {
            if(e.charCode != 44 && e.charCode != 46 && e.charCode != 62 && e.charCode != 35) //to allow : > ,
            {
                if(e.preventDefault)
                {
                    e.preventDefault();
...
function tbx_fnAlphaNumericOnBlur(ctrl)
{   //.:46, >:62, ,:44, #:35
    var text=ctrl.value;
    var iCount=0;
    var bInvalid=0;
...
function tbx_fnAlphaNumericType1(e, ctrl)
{   //  / 47  - 45
    if (!e) e=window.event;
    if (e.charCode)
    {
...
function tbx_fnAlphaNumericType1OnBlur(ctrl)
{   //  / 47  - 45
    var text=ctrl.value;
    var iCount=0;
    var bInvalid=0;
...
function tbx_fnUserName(e, ctrl)
{   //.:46, >:62, ,:44,
...
// Only for Requrie fild validater    OnClientClick='javascript:return ValidateAllTextForm();'
       ...
       function ValidateAllTextForm()
        ...
        else
        {
            ...
            alert("कृपया सभी अपेक्षित फील्ड भरे / Please fill all required fields");
                return false;
